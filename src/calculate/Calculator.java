...
public class Calculator {
    // Declare addition method instance methods
    // Declare two variables int a and int b
    ...
    // method for calculationResult with three parameters
    public void calculationResult(int a, int b, char symbol){
        ...
        switch (symbol) {
            ...
            case '/' :
                ...
                break;
            default:
                System.out.println("Invalid symbol. Please use of '+' , '-' ,'*', or '/' ");
